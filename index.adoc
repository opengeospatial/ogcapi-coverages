...
Coverage subsetting is indicated through the SUBSET parameter name. The value following the "=" symbol is built as follows:
    ...
    SubsetSpec:            UBSET = axisName ( intervalOrPoint )
    axisName:              {NCName}
