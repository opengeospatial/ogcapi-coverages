...
While the processing of the `subset` parameter is specific to the resource and operation for which it is applied, there are requirements which all implementations must address.
