...
NOTE: When the intervalOrPoint values fall partially outside of the range of valid values defined by the CRS for the identified axis, the service is expected to select the non-empty portion of the resource resulting from the subset operation.
