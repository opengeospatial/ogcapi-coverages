...
Recommendations for supporting a `Prefer:` request header in the <<rc_scaling_spatial, Scaling>> and <<rc_subsetting_spatial, Subsetting>> requirements classes allow clients to specify a preferred
