...
* **http://www.opengis.net/def/rel/ogc/1.0/coverage-scenes**: The target IRI points to a list of scenes of which the coverage collection is comprised, as defined by the <<rc-scenes, "Scenes" requirements class>>.
