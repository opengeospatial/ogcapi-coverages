:Title: OGC API - Coverages - Part 1: Core
:titletext: OGC API - Coverages - Part 1: Core
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/is/ogcapi-coverages-1/1.0
|Internal reference number of this OGC(R) document: 19-087
|Version: 1.0.0rc2
|Category: OGC(R) Implementation Specification
|Editors: Charles Heazel, Jérôme Jacovella-St-Louis
|===
...
|===
|*Copyright notice*
|Copyright (C) 2019-2026 Open Geospatial Consortium
...
include::clause_8_subsetting.adoc[]

// include::removed_clause_domainset-subset.adoc[]

include::clause_9_scaling.adoc[]

include::clause_recommendations_interpolation.adoc[]

include::clause_10_field_selection.adoc[]

include::clause_11_CRS.adoc[]

include::clause_12_coverage_tiles.adoc[]

include::clause_14_encodings.adoc[]

include::clause_15_api_operations.adoc[]
