...
the list of supported conformance classes will differ for each collection, as described in <<req_core_conformance_success>>.
...
For example, a 4D coverage with some data only available at some pressure level for particular temporal instant.
