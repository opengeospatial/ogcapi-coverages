...
Some collections are sparse by nature, with data not filling the entire extent of some dimensions at each point along
another dimension.

For example, weather stations capturing observations at different times.

Implementing this requirements class simplifies the use of such data by collapsing the values along spatial dimension(s)
...
When subsetting a temporal coverage, the time of its individual components (such as the cells of a gridded coverage) must be considered.
...
Implementing this requirements class simplifies the use of such data by collapsing the values along a temporal dimension
...
When subsetting a coverage, the n-dimensional geometry of its individual components (such as the cells of a gridded coverage) must be considered.
...
Implementing this requirements class simplifies the use of such data by collapsing the values along a general dimension
around a specified position of interest.
