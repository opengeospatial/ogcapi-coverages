...
The API may also integrate additional functionality related to scenes, such as for advanced filtering capabilities when listing scenes, as defined in _OGC API - Records_ _Local Resource Catalogus_ and/or
