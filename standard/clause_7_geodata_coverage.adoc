...
include::requirements/geodata-coverage/REQ_coverage-collection-links.adoc[]

This schema also includes an `extent` element. That element is further restricted as follows:

include::requirements/geodata-coverage/REQ_coverage-collection-extent-restrictions.adoc[]
...
include::requirements/geodata-coverage/REQ_extent-uad-definition.adoc[]
