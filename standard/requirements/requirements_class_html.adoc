...
^|A |The coverage resource, as defined in the Coverages API Core requirements class, SHALL support negotiating an HTML response using the `text/html` media type.
