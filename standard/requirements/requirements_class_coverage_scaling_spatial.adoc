...
^|A | The implementation SHOULD default to a continuous interpolation method,
...
type `continuous`, and `[ogc-interpolation:nearest-neighbor]` or `[ogc-interpolation:modal]` otherwise.
|===
