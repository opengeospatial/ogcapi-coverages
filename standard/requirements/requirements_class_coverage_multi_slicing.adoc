...
(<<rec_scaling-spatial_prefer-header>>) for requesting a particular interpolation method also applies for multi-slicing, exactly as if each slice was requested separately.
