...
^|A |If a particular collection is suitable for a CoverageJSON representation, the coverage resource as defined in the Coverages API Core requirements class SHALL support negotiating a https://docs.ogc.org/cs/21-069r2/21-069r2.html[CoverageJSON] response using the `application/vnd.cov+json` media type.
