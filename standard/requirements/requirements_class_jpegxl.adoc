...
^|A |Two-dimensional coverage responses for the coverage resource, as defined in the Coverages API Core requirements class, SHALL support negotiating a https://jpeg.org/jpegxl/[JPEG XL] response using the `image/jxl` media type.
