...
^|A |Two-dimensional coverage responses for the coverage resource, as defined in the Coverages API Core requirements class, SHALL support negotiating a https://jpeg.org/jpeg2000/[JPEG 2000] response using the `image/jp2` media type.
