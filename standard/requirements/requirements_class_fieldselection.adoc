...
^|E |The implementation SHALL interpret an `*` (asterisk) at the begining or at the end of the comma-separated list as all other fields before or after the listed fields, respectively, as per the numeric `x-ogc-field-index` order.
