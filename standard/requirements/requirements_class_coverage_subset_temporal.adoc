...
----
When the primary temporal dimension can be mapped to UTC and the Gregorian calendar, the syntax of `date-time` is specified by link:https://tools.ietf.org/html/rfc3339#section-5.6[RFC 3339, 5.6]
with the extension of allowing an hour value of 24 as defined in <<ISO_8601-1,ISO 8601-1>>.
