...
^|P |The Implementation SHALL return a 4xx error if a slicing operation is performed on the same dimension for which a scaling operation
...
[[rec_subsetting-spatial_subset-crs-axis-aliases]]
[width="90%",cols="2,6a"]
|===
^|*Recommendation {counter:rec-id}* |*/rec/subsetting-spatial/subset-crs-axis-aliases*
...
[[per_subsetting-spatial_slice-sparse-dimension]]
[width="90%",cols="2,6a"]
|===
...
[[rec_subsetting-spatial_slice-prefer-header]]
[width="90%",cols="2,6a"]
|===
...
[[rec_subsetting-spatial_slice-default-interpolation]]
[width="90%",cols="2,6a"]
|===
...
[[req_subsetting-spatial_slice-preference-applied]]
[width="90%",cols="2,6a"]
|===
...
[[req_subsetting-spatial_slice-preference-handling]]
[width="90%",cols="2,6a"]
|===
...
[[per_subsetting-spatial_aligned-spatial-interpolation]]
[width="90%",cols="2,6a"]
|===
