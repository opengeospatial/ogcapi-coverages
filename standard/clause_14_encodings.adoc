...
Implementations wishing to present different constituent parts of a coverage as separate resources can consider implementing the <<rc-scenes, _Scenes_ requirements class>>, where
