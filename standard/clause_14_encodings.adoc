...
Implementations wishing to present different constituent parts of a coverage as separate resources can consider implementing an eventual _Scenes_ extension, where
