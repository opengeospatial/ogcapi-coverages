...
This Coverages API CIS JSON requirements class defines a permission for implementations to support a `profile` query parameter which can be used by a client to retrieve only some of these aspects of the coverage e.g.,
