...
* [[OAPI_Common-Geodata]] OGC 20-024: *OGC API - Common - Part 2: Geospatial Data*, (Draft) https://docs.ogc.org/DRAFTS/20-024.html[https://docs.ogc.org/DRAFTS/20-024.html]
