...
* [[OGC07-011r2,OGC 07-011r2]] OGC: OGC 07-011r2, *OGC Abstract Specification Topic 6: Schema for Coverage Geometry and Functions – Part 1: Fundamentals*, version 2.0 (consistent with ISO 19123-1:2023), 2023 https://docs.ogc.org/as/07-011r2/07-011r2.pdf
