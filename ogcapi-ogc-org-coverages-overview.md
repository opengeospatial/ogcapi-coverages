...
Additionally, [Coverages: describing properties that vary with location (and time)](https://www.w3.org/TR/sdw-bp/#coverages) in the W3C/OGC Spatial Data on the Web Best Practice document may be considered.
...
but the draft OGC API - Coverages Part 1: Core standard further extends it with the following properties:
