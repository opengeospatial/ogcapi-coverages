...
There are no coverage-specific requirements related to network protocols. API-Common requirements are sufficient to describe this capability for the API-Coverages standard. The applicable API-Common requirements are as follows:
