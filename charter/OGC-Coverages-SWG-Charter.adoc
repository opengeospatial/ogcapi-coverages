...
The {swgname} SWG work program will also include development of extensions to the OGC API - Coverages Core Standards including:
...
The {swgname} SWG will explore and specify how the OGC API - Coverages shall support the following coverage format standards:
