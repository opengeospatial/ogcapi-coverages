...
listing and discover these scenes, while also supporting STAC items representations for these scenes.

The {swgname} SWG will define requirements classes as part of OGC API - Coverages for coverage data respones in format standards:
